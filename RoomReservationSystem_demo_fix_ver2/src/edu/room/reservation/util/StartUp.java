...
public class StartUp {
    ...
    private static final UserService userService = new UserService(userRepo, resRepo);
    private static final RoomService roomService = new RoomService(roomRepo, resRepo);
